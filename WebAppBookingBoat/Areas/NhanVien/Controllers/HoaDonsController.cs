...
{
    [Area("NhanVien")]
    [Authorize(Roles = "Staff, Nhân viên, Admin")]
    public class HoaDonsController : Controller
    {
        ...
        private async Task PopulateListsAsync(nvHoaDonCreateViewModel vm)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var viewModel = new nvHoaDonViewModel
            {
                ...
                DanhSachVe = hoaDon.Ves?.Select(v => new nvVeChiTietViewModel
                {
                    MaVe = v.MaVe,
                ...
                }).ToList() ?? new List<nvVeChiTietViewModel>()
            };
        ...
        {
            var vm = new nvHoaDonCreateViewModel();
        ...
        public async Task<IActionResult> Create(nvHoaDonCreateViewModel vm)
        {
